...
struct GlobalExtensions {
  GlobalExtensions()
      : dns(80), dns_with_ssl(443), ch_mh_lb(CONS_HASH_LB_MURMUR3),
        ch_md5_lb(CONS_HASH_LB_MD5), ch_ketama_lb(CONS_HASH_LB_KETAMA),
        ch_mh_bl_lb(CONS_HASH_LB_MURMUR3), constant_cl(0) {}
...
static void *GlobalUpdate(void *) {
  ...
  bvar::PassiveStatus<int64_t> var_iobuf_block_count_hit_tls_threshold(
      "iobuf_block_count_hit_tls_threshold", GetIOBufBlockCountHitTLSThreshold,
      nullptr);
...
static void GlobalInitializeOrDieImpl() {
  ...
  if (bthread_set_span_funcs(CreateBthreadSpanAsVoid, DestroyRpczParentSpan,
                             EndBthreadSpan) != 0) {
  ...
  LoadBalancerExtension()->RegisterOrDie("c_murmurhash_bl",
                                         &g_ext->ch_mh_bl_lb);
  ...
  CompressHandler snappy_compress = {SnappyCompress, SnappyDecompress,
                                     "snappy"};
  ...
  // Protocols
  Protocol transport_handshake_protocol = {ParseTransportHandshake,
                                           nullptr,
                                           nullptr,
                                           ProcessTransportHandshake,
                                           nullptr,
                                           nullptr,
                                           nullptr,
                                           nullptr,
  ...
  if (RegisterProtocol(PROTOCOL_RDMA_HANDSHAKE, transport_handshake_protocol) !=
      0) {
    exit(1);
  }
  ...
  Protocol streaming_protocol = {
      ParseStreamingMessage,   nullptr,        nullptr, ProcessStreamingMessage,
      ProcessStreamingMessage, nullptr,        nullptr, nullptr,
  ...
  Protocol public_pbrpc_protocol = {
      ...
      nullptr, ProcessPublicPbrpcResponse, nullptr, nullptr, nullptr,
  ...
  Protocol couchbase_protocol = {ParseCouchbaseMessage,
                                 ...
                                 nullptr,
                                 ProcessCouchbaseResponse,
                                 nullptr,
                                 nullptr,
                                 GetCouchbaseMethodName,
                                 CONNECTION_TYPE_ALL,
                                 "couchbase"};
  ...
  Protocol mongo_protocol = {
      ParseMongoMessage, nullptr, nullptr, ProcessMongoRequest,    nullptr,
      nullptr,           nullptr, nullptr, CONNECTION_TYPE_POOLED, "mongo"};
...
// static link issue)
  ...
  CHECK(bthread_start_background(&th, &attr, GlobalUpdate, nullptr) == 0)
      << "Fail to start GlobalUpdate";
}

void GlobalInitializeOrDie() {
  if (pthread_once(&register_extensions_once, GlobalInitializeOrDieImpl) != 0) {
